...
var getVersionUsageInternal = require('./versionCounter.js');
...
function loadGraph() {
  ...
  var api = {
    ...
    /**
     * Gets version usage information: how many packages depend on each version
     * of the library?
     */
    getVersionUsage: getVersionUsage
  }
  ...
  function getVersionUsage(nodeId, includeNames) {
    return getVersionUsageInternal(graph, nodeId, includeNames);
  }
